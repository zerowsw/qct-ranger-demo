...
<p><img src="./qct-icons/transform-clock-dark.svg" style="margin-bottom: 1px; vertical-align: middle;"></img> Transformation duration: 185 min(s) <p>
...
<p><img src="./qct-icons/transform-smartStepInto-dark.svg" style="margin-bottom: 1px; vertical-align: middle;"></img> Planned deprecated code instances replaced: 55 of 99 <p>
...
```
The Maven build failed with one error while processing the POMs. The error was that the version was missing for the javax.xml.bind:jaxb-api dependency in the org.apache.ranger:ranger-knox-plugin:3.0.0-SNAPSHOT project at line 143. More details can be found in the full log.
```
