...
public class TestOzoneResourceMapper {
    ...
    public void testInvalidKeyEntityOFSLegacyDotDelimiter() throws Exception {
        ...
        try {
            ...
            Assertions.assertFalse(true, "Expected buildResource() to fail. But it returned " + resource+". "
                + "'/' not supported as delimiter when legacy flag is enabled");
    ...
    private void assertException(RangerAtlasEntity entity, String exceptionMessage) {
        try {
            ...
            Assertions.assertTrue(excp.getMessage().startsWith(exceptionMessage),
                    "Unexpected exception message: expected=" + exceptionMessage + "; found " + excp.getMessage());
        }
    }
}
