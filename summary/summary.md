...
<p><img src="./qct-icons/transform-clock-dark.svg" style="margin-bottom: 1px; vertical-align: middle;"></img> Transformation duration: 234 min(s) <p>
...
<p><img src="./qct-icons/transform-dependencyAnalyzer-dark.svg" style="margin-bottom: 1px; vertical-align: middle;"></img> Additional dependencies added: 243 <p>
<p><img src="./qct-icons/transform-smartStepInto-dark.svg" style="margin-bottom: 1px; vertical-align: middle;"></img> Planned deprecated code instances replaced: 51 of 99 <p>
...
```
The Maven build failed with compilation errors in the CredentialsProviderUtil.java source file in the ranger-plugins-cred module. 43 compilation errors were reported related to illegal starts of expressions, missing identifiers, and expected classes/interfaces. The build failed at the compile goal for the ranger-plugins-cred module.
```
...
| `ch.qos.logback:logback-classic` | Updated | 1.3.14 | 1.5.8 |
| `ch.qos.logback:logback-core` | Updated | 1.3.14 | 1.5.8 |
| `ch.qos.reload4j:reload4j` | Updated | 1.2.19 | 1.2.25 |
| `com.amazonaws:aws-java-sdk-kms` | Updated | 1.12.765 | 1.12.772 |
| `com.amazonaws:aws-java-sdk-logs` | Updated | 1.12.765 | 1.12.772 |
...
| `com.github.eirslett:frontend-maven-plugin` | Updated | 1.12.1 | 1.15.1 |
| `com.github.spotbugs:spotbugs-maven-plugin` | Updated | 4.7.3.5 | 4.8.6.4 |
| `com.google.cloud:google-cloud-kms` | Updated | 2.3.0 | 2.52.0 |
...
| `com.google.protobuf:protobuf-java` | Updated | 3.19.6 | 4.28.2 |
| `com.google.protobuf:protobuf-java-util` | Updated | 3.19.6 | 4.28.2 |
...
| `com.nimbusds:nimbus-jose-jwt` | Updated | 9.31 | 9.41.1 |
...
| `com.zaxxer:HikariCP` | Updated | 4.0.3 | 6.0.0 |
| `commons-beanutils:commons-beanutils` | Updated | 1.9.4 | 20030211.134440 |
| `commons-cli:commons-cli` | Updated | 1.3.1 | 20040117.000000 |
| `commons-codec:commons-codec` | Updated | 1.15 | 20041127.091804 |
| `commons-collections:commons-collections` | Updated | 3.2.2 | 20040616 |
| `commons-dbcp:commons-dbcp` | Updated | 1.4 | 20030825.184428 |
| `commons-io:commons-io` | Updated | 2.11.0 | 20030203.000550 |
| `commons-lang:commons-lang` | Updated | 2.6 | 20030203.000129 |
| `commons-logging:commons-logging` | Updated | 1.2 | 1.3.4 |
| `commons-net:commons-net` | Updated | 3.9.0 | 20030805.205232 |
| `commons-pool:commons-pool` | Updated | 1.6 | 20030825.183949 |
| `dnsjava:dnsjava` | Updated | 2.1.7 | 3.6.2 |
| `io.airlift:aircompressor` | Updated | 0.27 | 2.0.2 |
| `io.airlift:bootstrap` | Updated | 0.192 | 268 |
| `io.airlift:configuration` | Updated | 0.192 | 268 |
| `io.airlift:log` | Updated | 0.192 | 268 |
| `io.netty:netty-all` | Updated | 4.1.100.Final | 4.1.113.Final |
| `io.opentelemetry:opentelemetry-api` | Updated | 1.40.0 | 1.42.1 |
| `io.opentelemetry:opentelemetry-context` | Updated | 1.40.0 | 1.42.1 |
...
| `io.trino:trino-jdbc` | Updated | 451 | 458 |
| `io.trino:trino-spi` | Updated | 451 | 458 |
...
| `javax.xml.bind:jaxb-api` | Updated | - | 2.3.1 |
| `jline:jline` | Updated | 0.9.94 | 2.14.6 |
| `joda-time:joda-time` | Updated | 2.10.6 | 2.13.0 |
| `mysql:mysql-connector-java` | Removed | 5.1.49 | - |
| `net.htmlparser.jericho:jericho-html` | Updated | 3.3 | 3.4 |
| `net.java.dev.jna:jna` | Updated | 5.7.0 | 5.15.0 |
| `net.java.dev.jna:jna-platform` | Updated | 5.7.0 | 5.15.0 |
...
| `org.apache.directory.api:api-i18n` | Updated | 1.0.3 | 2.1.7 |
...
| `org.apache.hbase.thirdparty:hbase-shaded-miscellaneous` | Updated | 4.1.7 | 4.1.8 |
| `org.apache.hbase.thirdparty:hbase-shaded-netty` | Updated | 4.1.7 | 4.1.8 |
| `org.apache.hbase.thirdparty:hbase-shaded-protobuf` | Updated | 4.1.7 | 4.1.8 |
...
| `org.apache.httpcomponents.client5:httpclient5` | Added | - | 5.4 |
...
| `org.apache.kafka:kafka-clients` | Updated | 2.8.2 | 3.8.0 |
| `org.apache.kafka:kafka_${scala.binary.version}` | Updated | 2.8.2 | 3.8.0 |
| `org.apache.kerby:kerb-simplekdc` | Updated | 2.0.3 | 2.1.0 |
| `org.apache.logging.log4j:log4j-api` | Updated | 2.17.2 | 2.24.0 |
| `org.apache.logging.log4j:log4j-core` | Added | - | 2.24.1 |
| `org.apache.logging.log4j:log4j-to-slf4j` | Updated | 2.17.2 | 2.24.0 |
...
| `org.apache.maven.plugins:maven-checkstyle-plugin` | Updated | 3.1.0 | 3.5.0 |
...
| `org.apache.maven.plugins:maven-pmd-plugin` | Updated | 3.14.0 | 3.25.0 |
| `org.apache.maven.plugins:maven-resources-plugin` | Updated | 2.7 | 3.3.1 |
| `org.apache.maven.plugins:maven-surefire-plugin` | Updated | 3.0.0-M6 | - |
| `org.apache.orc:orc-core` | Updated | 1.5.8 | 2.0.2 |
| `org.apache.orc:orc-shims` | Updated | 1.5.8 | 2.0.2 |
...
| `org.apache.solr:solr-core` | Updated | 8.11.3 | 9.7.0 |
| `org.apache.solr:solr-solrj` | Updated | 8.11.3 | 9.7.0 |
| `org.apache.storm:storm-core` | Updated | 1.2.4 | 2.6.4 |
| `org.apache.tez:tez-dag` | Updated | 0.9.1 | 0.10.4 |
| `org.apache.thrift:libthrift` | Updated | 0.14.0 | 0.21.0 |
| `org.apache.tomcat.embed:tomcat-embed-core` | Updated | 8.5.94 | 10.1.30 |
| `org.apache.tomcat.embed:tomcat-embed-el` | Updated | 8.5.94 | 10.1.30 |
| `org.apache.tomcat.embed:tomcat-embed-jasper` | Updated | 8.5.94 | 10.1.30 |
| `org.apache.tomcat.embed:tomcat-embed-websocket` | Updated | 8.5.94 | 10.1.30 |
| `org.apache.tomcat:tomcat-annotations-api` | Updated | 8.5.94 | 10.1.30 |
| `org.apache.tomcat:tomcat-jasper-el` | Updated | 8.5.94 | 10.1.30 |
| `org.apache:apache` | Updated | 20 | 33 |
| `org.codehaus.mojo:exec-maven-plugin` | Updated | 1.6.0 | 3.4.1 |
...
| `org.eclipse.jetty:jetty-client` | Updated | 9.4.49.v20220914 | 12.0.13 |
| `org.eclipse.jetty:jetty-http` | Updated | 9.4.51.v20230217 | 12.0.13 |
| `org.eclipse.jetty:jetty-server` | Updated | 9.4.51.v20230217 | 12.0.13 |
| `org.eclipse.jetty:jetty-util` | Updated | 9.4.51.v20230217 | 12.0.13 |
| `org.eclipse.persistence:eclipselink` | Updated | 2.7.12 | 4.0.4 |
| `org.eclipse.persistence:javax.persistence` | Removed | 2.1.0 | - |
| `org.elasticsearch.client:elasticsearch-rest-client` | Updated | 7.10.2 | 8.15.1 |
| `org.elasticsearch.client:elasticsearch-rest-high-level-client` | Updated | 7.10.2 | 7.17.24 |
| `org.elasticsearch.plugin:aggs-matrix-stats-client` | Updated | 7.10.2 | 7.17.24 |
| `org.elasticsearch.plugin:lang-mustache-client` | Updated | 7.10.2 | 7.17.24 |
| `org.elasticsearch.plugin:parent-join-client` | Updated | 7.10.2 | 7.17.24 |
| `org.elasticsearch.plugin:rank-eval-client` | Updated | 7.10.2 | 7.17.24 |
| `org.elasticsearch:elasticsearch` | Updated | 7.10.2 | 8.15.1 |
| `org.elasticsearch:elasticsearch-core` | Updated | 7.10.2 | 8.15.1 |
| `org.elasticsearch:elasticsearch-secure-sm` | Updated | 7.10.2 | 8.15.1 |
| `org.elasticsearch:elasticsearch-x-content` | Updated | 7.10.2 | 8.15.1 |
...
| `org.hamcrest:hamcrest` | Updated | 2.2 | 3.0 |
| `org.jacoco:jacoco-maven-plugin` | Updated | 0.8.7 | 0.8.12 |
| `org.junit.jupiter:junit-jupiter` | Added | - | 5.11.3 |
| `org.junit.jupiter:junit-jupiter-api` | Updated | 5.10.0 | 5.11.0 |
| `org.junit.vintage:junit-vintage-engine` | Updated | 5.10.0 | 5.11.0 |
| `org.kohsuke:libpam4j` | Updated | 1.10 | 1.11 |
| `org.mockito:mockito-all` | Removed | 1.10.19 | - |
| `org.mockito:mockito-core` | Updated | 3.0.0 | 5.13.0 |
| `org.mockito:mockito-junit-jupiter` | Updated | 3.0.0 | 5.13.0 |
| `org.scala-lang:scala-library` | Updated | 2.12.10 | 2.13.15 |
| `org.slf4j:jcl-over-slf4j` | Updated | 2.0.13 | 2.0.16 |
| `org.slf4j:jul-to-slf4j` | Updated | 2.0.13 | 2.0.16 |
| `org.slf4j:log4j-over-slf4j` | Updated | 2.0.13 | 2.0.16 |
| `org.slf4j:slf4j-api` | Updated | 2.0.13 | 2.0.16 |
| `org.springframework.boot:spring-boot-starter-validation` | Added | - | 3.3.4 |
| `org.springframework.ldap:spring-ldap-core` | Updated | 2.4.1 | 3.2.6 |
| `org.springframework.security:spring-security-acl` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework.security:spring-security-config` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework.security:spring-security-core` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework.security:spring-security-ldap` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework.security:spring-security-test` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework.security:spring-security-web` | Updated | 5.7.12 | 6.3.3 |
| `org.springframework:spring-aop` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-beans` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-context` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-context-support` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-core` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-expression` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-jdbc` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-orm` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-test` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-tx` | Updated | 5.3.39 | 6.1.13 |
| `org.springframework:spring-web` | Updated | 5.3.39 | 6.1.13 |
| `org.testng:testng` | Updated | 7.5.1 | 7.10.2 |
| `org.yaml:snakeyaml` | Updated | 2.2 | 2.3 |
